 ...
 *
 * The Business Hours Widget is an organized, maintainable boilerplate for building widgets using WordPress best practices.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Tent_Business_Hours
 ...
 * Description:       Easily update business hours in WordPress
 * Version:           1.0.0
 * Author:            Jefe
...
class EVR_Business_Hours extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'evr-business-hours';
...
add_action( 'widgets_init', function(){
     register_widget( 'EVR_Business_Hours' );
});
